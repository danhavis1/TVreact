...
export default function TvDetail() {
  ...
  return (
    ...
    justify-content-between py-3 px-2 bgColorB"
        >
          <div className="d-flex gap-2 align-items-center">
            <PiTelevisionBold sixe="50px" color="purple" />
   ...
   align-items-center p-4 "
          ...
          />
          <div className="mt-4 d-md-flex align-items-center justify-content-between p-3 bgColorA">
            <div>
              <span className="fw-bold text-white me-2">Genres:</span>
        ...
        <div className="d-flex gap-4 overflow-x-scroll">
          ...
          <Image src={item.character?.image?.original}
           ...
           <p className="textColor fs-5 text-center">{item.character?.name}</p>
          </div>
          ))} 
